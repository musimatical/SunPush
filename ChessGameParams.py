...
class TkinterGameSetupParams:
	...
	def __init__(self):
		...
		Radiobutton(self.frame, text="Sunpush AI",variable=self.tk_player1Type,value="SunpushAI").grid(row=2,column=4)
		...
		Radiobutton(self.frame, text="Sunpush AI",variable=self.tk_player2Type,value="SunpushAI").grid(row=3,column=4)
		self.tk_player2Type.set("SunpushAI")
