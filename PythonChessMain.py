...
class PythonChessMain:
    ...
    def MainLoop(self):
        ...
        turnCount = 0
        while not self.Rules.IsCheckmate(self.Board,self.player[currentPlayerIndex].color):
            ...
            if self.Rules.IsInCheck(self.Board,currentColor):
